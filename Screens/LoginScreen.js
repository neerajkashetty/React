...
import {View, StyleSheet, Image, TouchableOpacity ,state, Alert} from 'react-native';
  ...
  touchIdAuth = () => {
    ...
    return (
        <KeyboardAwareScrollView style={{flex:1}} behavior='padding' backgroundColor='white'>
          ...
          <View  style={{alignItems:'flex-end', paddingRight:33 }}>
            <TouchableOpacity>
              <Text style ={{fontSize:20, fontWeight:'bold', color:'blue'}}>SignUp</Text>
            </TouchableOpacity>
            </View>
         ...
         <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor:'white'}}>
          ...
          />*/}
           ...
           <View style={{flexDirection:'row' ,margin: 20 , paddingVertical:20}}>
             ...
             onLongPress={()=> props.navigation.navigate('Lists')}
             >
